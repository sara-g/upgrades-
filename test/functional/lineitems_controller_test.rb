...
class LineitemsControllerTest < ActionController::TestCase
  ...
  test "should create lineitem" do
    assert_difference('Lineitem.count') do
      post :create, lineitem: { event_id: @lineitem.event_id, profile_id: @lineitem.profile_id, upgrade_id: @lineitem.upgrade_id }
    end
  ...
  test "should update lineitem" do
    put :update, id: @lineitem, lineitem: { event_id: @lineitem.event_id, profile_id: @lineitem.profile_id, upgrade_id: @lineitem.upgrade_id }
    assert_redirected_to lineitem_path(assigns(:lineitem))
  end
